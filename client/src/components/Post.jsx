...
export default function Post({ _id, title, summary, cover, createdAt, author }) {
  ...
  return (
<div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden md:max-w-2xl my-5 h-[340px] md:h-[355px]">
<div className="flex flex-col justify-between h-full">
        ...
        <div className="px-6 mt-[284px] sm:mt-[295px] fixed  -my-2 sm:pb-14 pb-10 ">
       <div className=" ">
